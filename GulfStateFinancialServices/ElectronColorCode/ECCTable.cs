...
namespace ElectronColorCode
{
    public class ECCTable
    {
        ...
        public readonly Dictionary<string, ElectronColorCode> eccTable = new Dictionary<string, ElectronColorCode>()
        {
            ...
            { Names.Gray, new ElectronColorCode(Names.Gray, Colors.Gray, SignificantFigures.Grey, Multipliers.Grey, Tolerances.Grey) },
        ...
        public ElectronColorCode GetElectronColorCode(string eccName)
        {
            ...
            if (eccTable.TryGetValue(CultureInfo.CurrentCulture.TextInfo.ToTitleCase(eccName.ToLower()), out var eccValue))
            {
                return eccValue;
            }
